      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white">Exop</h3>
            <p className="text-gray-400">
              Empowering traders with cutting-edge technology and reliable execution.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/blog" className="text-gray-400 hover:text-blue-500 transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/documentation" className="text-gray-400 hover:text-blue-500 transition-colors">
                  Documentation
                </Link>
              </li>
              <li>
                <Link href="/api" className="text-gray-400 hover:text-blue-500 transition-colors">
                  API
                </Link>
              </li>
              <li>
                <Link href="/status" className="text-gray-400 hover:text-blue-500 transition-colors">
                  System Status
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/support" className="text-gray-400 hover:text-blue-500 transition-colors">
                  Support
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Exop. All rights reserved.
            </p>
            <div className="flex space-x-6">
              ...
              <Link href="/cookies" className="text-gray-400 hover:text-blue-500 text-sm transition-colors">
                Cookie Policy
              </Link>
            </div>
          </div>
